		...
		<nav class="navbar navbar-expand-md navbar-dark bg-dark">
			<div class="container navbar-nav">
				...
				<div class="navbar-collapse">
					...
					<ul class="navbar-nav">
						<li class="nav-item">
							<a class="nav-link" href= "<?= RACINE_WEB; ?>admin/categories.php">Gestion de catégories</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href= "<?= RACINE_WEB; ?>admin/produits.php">Gestion de produits</a>
						</li>
						<li class="nav-item">
